...
const getIsSalesManagerPortal = () => {
  if (typeof window === "undefined") return false;

  const hostname = window.location.hostname.toLowerCase();

  return hostname.startsWith("mikeharr.");
};

const getCurrentProjectManager = () => {
  if (typeof window === "undefined") return null;

  if (getIsSalesManagerPortal()) return null;
...
const [marketingSpendByChannel, setMarketingSpendByChannel] = useState(() =>
 ...
 const isSalesManagerPortal = getIsSalesManagerPortal();
...
quarterlyReferralStatus,
  ...
  useEffect(() => {
    if (!isSalesManagerPortal) return;
...
const referralGoalMetMessages = [
  ...
  "you met the referral goal! That means people trust you enough to send opportunities your way. That's fire.",
